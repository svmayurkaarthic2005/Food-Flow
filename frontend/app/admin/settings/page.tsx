...
const ADMIN_SETTINGS_KEY = 'foodflow:admin-settings'
  ...
  const handleSaveSettings = () => {
    try {
      ...
      toast({
        ...
        description: 'Your admin settings were saved successfully.',
      })
    } catch (error) {
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Receive weekly platform reports</p>
            </div>
            <Switch
