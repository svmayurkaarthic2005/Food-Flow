...
import { AlertCircle, MapPin, Clock, Zap, Navigation, Wifi, WifiOff, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600">See your food donation being delivered in real-time</p>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-sm text-gray-600">
                Your donation will reach {destination.name} soon
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              {current_location ? (
                ...
                <p className="text-gray-500">Waiting for driver to start</p>
              )}
            </CardContent>
          </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div>
                <p className="text-sm font-semibold text-gray-600">Receiving Organization</p>
              ...
              {delivery.completedAt && (
                <div>
                  <p className="text-sm font-semibold text-gray-600">Delivered At</p>
        ...
        <Card className="mt-6 bg-green-50 border-green-200">
          <CardContent className="pt-6">
            ...
            <p className="text-sm text-green-700">
              Your generous donation is making a real difference. You can track the delivery in real-time 
              and see exactly when your food reaches those who need it most.
            </p>
          </CardContent>
        </Card>
      </div>
